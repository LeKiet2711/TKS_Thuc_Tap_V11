...
namespace TKS_Thuc_Tap_V11_Data_Access.Controller.DM
{
	...
	{
		public List<CXNK_Nhap_Kho> FQ_718_NK_sp_sel_List_By_Created(DateTime? p_dtmFrom, DateTime? p_dtmTo)
		{
			...
			try
			{
				...
				CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "FQ_718_NK_sp_sel_List_By_Created",p_dtmFrom, p_dtmTo);
		...
		public long FQ_718_NK_sp_ins_Insert(CXNK_Nhap_Kho p_objData)
		{
			...
			try
			{
				v_iRes = Convert.ToInt64(CSqlHelper.ExecuteScalar(CConfig.TKS_Thuc_Tap_V11_Conn_String, "FQ_718_NK_sp_ins_Insert",
					p_objData.Kho_ID, p_objData.NCC_ID, p_objData.So_Phieu_Nhap_Kho, p_objData.Ngay_Nhap_Kho, p_objData.Ghi_Chu,
