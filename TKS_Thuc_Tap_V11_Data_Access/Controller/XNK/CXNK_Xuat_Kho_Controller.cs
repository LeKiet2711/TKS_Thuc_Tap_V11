...
namespace TKS_Thuc_Tap_V11_Data_Access.Controller.XNK
{
	...
	{
		public List<CXNK_Xuat_Kho> FQ_728_XK_sp_sel_List_By_Created(DateTime? p_dtmFrom, DateTime? p_dtmTo)
		{
		...
		public long FQ_728_XK_sp_ins_Insert(CXNK_Xuat_Kho p_objData)
		{
			...
			try
			{
				v_iRes = Convert.ToInt64(CSqlHelper.ExecuteScalar(CConfig.TKS_Thuc_Tap_V11_Conn_String, "FQ_728_XK_sp_ins_Insert",
					p_objData.Kho_ID, p_objData.So_Phieu_Xuat_Kho, p_objData.Ngay_Xuat_Kho, p_objData.Ghi_Chu, p_objData.Last_Updated_By,
