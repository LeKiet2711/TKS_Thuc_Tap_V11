...
namespace TKS_Thuc_Tap_V11_Data_Access.Controller.XNK
{
	...
	{
		public List<CXNK_Xuat_Nhap_Ton> F_744_ReportXuatNhapTon_sp_sel_List_By_Created(DateTime? p_dtmFrom, DateTime? p_dtmTo)
		{
			...
			try
			{
				...
				CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "F_744_ReportXuatNhapTon_sp_sel_List_By_Created", p_dtmFrom, p_dtmTo);
